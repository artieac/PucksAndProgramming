...
namespace PucksAndProgramming.OAuth.Client
{
    ...
    {
        /// <summary>
        /// Defines which element in the urn defines the area (PucksAndProgramming)
        /// </summary>
        ...
        /// </summary>
        private const string DefaultRealm = UrnPrefix + "PucksAndProgramming/Unknown/0/Unknown";
        ...
        /// <summary>
        /// Gets or sets the business area (such as PucksAndProgramming)
        /// </summary>
